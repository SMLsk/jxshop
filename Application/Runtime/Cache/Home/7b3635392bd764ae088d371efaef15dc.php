			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?php echo U('Cart/addCart');?>" method="post" class="choose">
						<ul>
						<?php if(is_array($single)): $i = 0; $__LIST__ = $single;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="product">
								<dl>
							...
							<li>
								<dl>
									<dt>购买数量：</dt>
									<dd>
										<a href="/Public/Home/javascript:;" id="reduce_num"></a>
										<input type="text" name="goods_count" value="1" class="amount"/>
										<a href="/Public/Home/javascript:;" id="add_num"></a>
									</dd>
								</dl>
							</li>
