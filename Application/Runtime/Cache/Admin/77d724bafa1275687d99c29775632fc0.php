...
<!-- <?php if(is_array($hasRules)): $i = 0; $__LIST__ = $hasRules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h1><?php echo ($vo); ?></h1><?php endforeach; endif; else: echo "" ;endif; ?> -->
