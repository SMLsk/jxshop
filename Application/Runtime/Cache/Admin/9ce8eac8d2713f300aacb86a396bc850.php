...
<body>
<h1>
    <span class="action-span"><a href=<?php echo U('add');?>>商品列表</a></span>
...
<div class="form-div">
    <form action="<?php echo U('index');?>" name="searchForm">
        ...
        <select name="cate_id">
            ...
            <?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($$vo["id"]) == "Think.get.cate_id"): ?>selected="selected"<?php endif; ?>>|<?php echo (str_repeat("--",$vo["lev"])); echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
...
<div class="list-div" id="listDiv">
    <table cellpadding="3" cellspacing="1">
        ...
        <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center">
			 <a href="<?php echo U('setNumber','id='.$vo['id']);?>" target="_blank" title="库存设置">库存设置</a>
            ...
            <a href="<?php echo U('dels','id='.$vo['id']);?>" onclick="return confirm('是否删除')" title="回收站"><img src="/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
